...
export const RecordSharingPage: React.FC = () => {
  ...
  return (
    <div className="p-6 space-y-6 max-w-4xl mx-auto">
      <div>
        <h1 className="text-2xl font-extrabold text-slate-900 font-bold">Doctor-to-Doctor Record Sharing</h1>
        <p className="text-xs text-slate-500">Transfer medical records across healthcare organizations using patient-authorized access tokens</p>
      </div>

      <form onSubmit={handleShareSubmit} className="glass-panel p-8 rounded-2xl border border-slate-200/80 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-xs font-semibold text-slate-600">Step 1 — Receiving Hospital</label>
            <select
              value={toHospitalId}
              onChange={(e) => {
              ...
              className="w-full bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs text-slate-900 font-bold"
            >
          ...
          <div className="space-y-1">
            <label className="text-xs font-semibold text-slate-600">Step 2 — Receiving Doctor</label>
            <select
              value={toDoctorId}
        ...
        <div className="space-y-1">
          <label className="text-xs font-semibold text-slate-600">Step 3 — Enter Patient Access Token</label>
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-white border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-xs font-mono font-bold text-emerald-600 uppercase"
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-xs font-semibold text-slate-600">Step 4 — Select Patient</label>
            <select
          ...
          <div className="space-y-1">
            <label className="text-xs font-semibold text-slate-600">Step 5 — Select Medical Record to Transfer</label>
            <select
